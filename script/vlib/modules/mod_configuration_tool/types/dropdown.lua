...
---@param option_obj mct_option The mct_option this wrapped_type is being passed.
...
function wrapped_type:ui_select_value(val)
    ...
    if is_uicomponent(currently_selected_uic) then
        _SetState(currently_selected_uic, "unselected")
    else
