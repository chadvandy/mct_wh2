...
--- Metatable for the mct_mod object.
local __mct_mod_mt = {
    __index = mct_mod,
    __tostring = function(self) return "MCT_MOD [" .. self._key .. "]" end,
}
...
function mct_mod.new(key)
    local o = table.copy_add({_key=key}, mct_mod)
    setmetatable(o, __mct_mod_mt)
